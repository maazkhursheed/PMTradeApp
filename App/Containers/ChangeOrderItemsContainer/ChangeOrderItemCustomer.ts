...
const ChangeOrderItemCustomerTemplate = (data: OwnProps) => {
  const { customerMsg, instruction, orderNo, originalOrder, userName, deliveryAddress, jobName, branchDetails } = data;
                      ...
                      <tr>
                        <td class="em_defaultlink " align="left" valign="top" style=" font-family:'ProximaNova-Bold', Arial, sans-serif; font-size:12px; line-height:20px; color:#000000; font-weight:500; padding-bottom:10px; padding-top:10px;">
                          <div id="Content_Text2" mktoname="Content text" class="job_name">
                            Some items in the order ${orderNo} for ${jobName} were changed by ${userName}. We will begin processing your order and we'll be in touch soon. <br>
...
export default ChangeOrderItemCustomerTemplate;
