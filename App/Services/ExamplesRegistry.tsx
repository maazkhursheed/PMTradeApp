  ...
  return (
    <View key={example.title}>
      <View style={ApplicationStyles.darkLabelContainer}>
        <Text style={ApplicationStyles.darkLabel} testID="compHeaderLabel" {...accessibility("compHeaderLabel")}>
          {example.title}
        </Text>
      </View>
      {example.usage.call()}
...
const renderPluginExample = example => {
  return (
    <View key={example.title}>
      <View style={ApplicationStyles.darkLabelContainer}>
        <Text style={ApplicationStyles.darkLabel} {...accessibility("pluginHeaderLabel")}>
          {example.title}
        </Text>
      </View>
      {example.usage.call()}
